...
*/
    ...
    public:
        ...
        void Execute() override
        {
            ...
            else
            {
                ...
                for (el = 0; el < OutNumberOfElements; el++)
                {
                    ...
                    else if (dimension == 3)
                    {
                        ...
                        if (sumIsolatedFreeSurf > 4)
                        {
                            std::cout << "sumIsolatedFreeSurf= " << sumIsolatedFreeSurf << std::endl;
                        }
                        if (numrigid == nds)
                        {
                            Alpha *= 0.95;
            ...
            if (mEchoLevel > 1 || number_of_slivers > 0)
            {
                std::cout << "SELECT_MESH_ELEMENTS. slivers: " << number_of_slivers << std::endl;
