...
#pragma omp parallel
		...
		if (sliversDetectedFromVolume > 0 || sliversDetectedFromShape > 0)
		{
			std::cout << "I have set ACTIVE=false to " << sliversDetectedFromVolume << " FromVolume-slivers and " << sliversDetectedFromShape << " FromShape-slivers." << std::endl;
		}
