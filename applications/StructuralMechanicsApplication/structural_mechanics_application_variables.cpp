...
KRATOS_CREATE_VARIABLE(double, DAMAGE_REACTION );
KRATOS_CREATE_VARIABLE(double, CRACK_STRAIN_ENERGY );
KRATOS_CREATE_VARIABLE(double, ELASTIC_STRAIN_ENERGY );
KRATOS_CREATE_VARIABLE(Vector, CRACK_STRESS );
KRATOS_CREATE_VARIABLE(Vector, ELASTIC_STRESS );
KRATOS_CREATE_VARIABLE(Matrix, DAMAGE_CONSTITUTIVE_MATRIX );
KRATOS_CREATE_VARIABLE(Matrix, UNDAMAGE_CONSTITUTIVE_MATRIX );
KRATOS_CREATE_VARIABLE(Matrix, P_MATRIX );
KRATOS_CREATE_VARIABLE(Matrix, Ch_MATRIX );
}
