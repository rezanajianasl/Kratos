...
Element::Pointer DamageSmallDisplacement::Create( IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties ) const
{
    return Kratos::make_intrusive<DamageSmallDisplacement>( NewId, GetGeometry().Create( ThisNodes ), pProperties );
}

/***********************************************************************************/
/***********************************************************************************/

Element::Pointer DamageSmallDisplacement::Create( IndexType NewId, GeometryType::Pointer pGeom, PropertiesType::Pointer pProperties ) const
{
    return Kratos::make_intrusive<DamageSmallDisplacement>( NewId, pGeom, pProperties );
}

/***********************************************************************************/
/***********************************************************************************/

DamageSmallDisplacement::~DamageSmallDisplacement()
{
}
...
Element::Pointer DamageSmallDisplacement::Clone (
    IndexType NewId,
    ...
    ) const
{
    ...
    DamageSmallDisplacement::Pointer p_new_elem = Kratos::make_intrusive<DamageSmallDisplacement>(NewId, GetGeometry().Create(rThisNodes), pGetProperties());
...
bool DamageSmallDisplacement::UseElementProvidedStrain() const
{
    return true;
}
...
void DamageSmallDisplacement::CalculateAll(
...
void DamageSmallDisplacement::CalculateKinematicVariables(
...
void DamageSmallDisplacement::SetConstitutiveVariables(
    KinematicVariables& rThisKinematicVariables,
...
void DamageSmallDisplacement::CalculateConstitutiveVariables(
    KinematicVariables& rThisKinematicVariables,
    ConstitutiveVariables& rThisConstitutiveVariables,
    ConstitutiveLaw::Parameters& rValues,
    const IndexType PointNumber,
...
void DamageSmallDisplacement::CalculateB(
    Matrix& rB,
    const Matrix& rDN_DX,
    const GeometryType::IntegrationPointsArrayType& IntegrationPoints,
    const IndexType PointNumber
...
void DamageSmallDisplacement::ComputeEquivalentF(
    Matrix& rF,
