...
namespace Kratos
{
void BaseDamageSolidElement::Initialize(const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
    ...
    if( GetProperties().Has(INTEGRATION_ORDER) ) {
        ...
        case 5:
            ...
            break;
        default:
            KRATOS_WARNING("BaseDamageSolidElement") << "Integration order " << integration_order << " is not available, using default integration order for the geometry" << std::endl;
...
void BaseDamageSolidElement::InitializeSolutionStep( ProcessInfo& rCurrentProcessInfo )
{
...
void BaseDamageSolidElement::InitializeNonLinearIteration( ProcessInfo& rCurrentProcessInfo )
{
    const GeometryType& r_geometry = GetGeometry();
    const Properties& r_properties = GetProperties();
    const auto& N_values = r_geometry.ShapeFunctionsValues(mThisIntegrationMethod);
...
void BaseDamageSolidElement::FinalizeNonLinearIteration( ProcessInfo& rCurrentProcessInfo )
{
    const GeometryType& r_geometry = GetGeometry();
    const Properties& r_properties = GetProperties();
    const auto& N_values = r_geometry.ShapeFunctionsValues(mThisIntegrationMethod);
...
void BaseDamageSolidElement::FinalizeSolutionStep( ProcessInfo& rCurrentProcessInfo )
{
...
void BaseDamageSolidElement::InitializeMaterial()
{
    KRATOS_TRY
...
ConstitutiveLaw::StressMeasure BaseDamageSolidElement::GetStressMeasure() const
{
...
bool BaseDamageSolidElement::UseElementProvidedStrain() const
{
    return false;
}
...
void BaseDamageSolidElement::ResetConstitutiveLaw()
{
    KRATOS_TRY
...
Element::Pointer BaseDamageSolidElement::Clone (
    IndexType NewId,
    ...
    ) const
{
    ...
    KRATOS_WARNING("BaseDamageSolidElement") << " Call BaseDamageSolidElement (base class) Clone " << std::endl;

    BaseDamageSolidElement::Pointer p_new_elem = Kratos::make_intrusive<BaseDamageSolidElement>(NewId, GetGeometry().Create(rThisNodes), pGetProperties());
...
void BaseDamageSolidElement::EquationIdVector(
...
void BaseDamageSolidElement::GetDofList(
...
void BaseDamageSolidElement::GetFirstDerivativesVector(
    Vector& rValues,
    int Step
    ) const
{
...
void BaseDamageSolidElement::GetSecondDerivativesVector(
    Vector& rValues,
    int Step
    ) const
{
...
void BaseDamageSolidElement::AddExplicitContribution(
...
void BaseDamageSolidElement::CalculateLocalSystem(
...
void BaseDamageSolidElement::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix,
                                             ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY;
    VectorType RHS;
...
void BaseDamageSolidElement::CalculateRightHandSide(
    VectorType& rRightHandSideVector,
    ProcessInfo& rCurrentProcessInfo
    )
{
...
void BaseDamageSolidElement::CalculateMassMatrix(
...
void BaseDamageSolidElement::CalculateDampingMatrix(
...
void BaseDamageSolidElement::CalculateOnIntegrationPoints(
...
void BaseDamageSolidElement::SetValuesOnIntegrationPoints(
    const Variable<bool>& rVariable,
    ...
    )
{
    if (mConstitutiveLawVector[0]->Has( rVariable)) {
        ...
        KRATOS_WARNING("BaseDamageSolidElement") << "The variable " << rVariable << " is not implemented in the current ConstitutiveLaw" << std::endl;
    }
}
...
void BaseDamageSolidElement::GetValueOnIntegrationPoints(
        const Variable<ConstitutiveLaw::Pointer>& rVariable,
        std::vector<ConstitutiveLaw::Pointer>& rValues,
        const ProcessInfo& rCurrentProcessInfo
        )
...
int  BaseDamageSolidElement::Check( const ProcessInfo& rCurrentProcessInfo ) const
{
    KRATOS_TRY;
...
void BaseDamageSolidElement::CalculateAll(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    const ProcessInfo& rCurrentProcessInfo,
...
double BaseDamageSolidElement::GetIntegrationWeight(
...
void BaseDamageSolidElement::CalculateShapeGradientOfMassMatrix(MatrixType& rMassMatrix, ShapeParameter Deriv) const
{
    KRATOS_TRY;
...
void BaseDamageSolidElement::CalculateKinematicVariables(
...
void BaseDamageSolidElement::CalculateConstitutiveVariables(
    KinematicVariables& rThisKinematicVariables,
...
void BaseDamageSolidElement::SetConstitutiveVariables(
    KinematicVariables& rThisKinematicVariables,
    ConstitutiveVariables& rThisConstitutiveVariables,
    ConstitutiveLaw::Parameters& rValues,
    const IndexType PointNumber,
...
Matrix& BaseDamageSolidElement::CalculateDeltaDisplacement(Matrix& DeltaDisplacement) const
{
    KRATOS_TRY
...
double BaseDamageSolidElement::CalculateDerivativesOnReferenceConfiguration(
    Matrix& rJ0,
    Matrix& rInvJ0,
    Matrix& rDN_DX,
    const IndexType PointNumber,
...
double BaseDamageSolidElement::CalculateDerivativesOnCurrentConfiguration(
    Matrix& rJ,
    Matrix& rInvJ,
    Matrix& rDN_DX,
    const IndexType PointNumber,
...
array_1d<double, 3> BaseDamageSolidElement::GetBodyForce(
...
void BaseDamageSolidElement::CalculateAndAddKm(
    MatrixType& rLeftHandSideMatrix,
    const Matrix& B,
    const Matrix& D,
...
void BaseDamageSolidElement::CalculateAndAddKg(
    MatrixType& rLeftHandSideMatrix,
    const Matrix& DN_DX,
...
void BaseDamageSolidElement::CalculateAndAddExtForceContribution(
    const Vector& rN,
    const ProcessInfo& rCurrentProcessInfo,
    const array_1d<double, 3>& rBodyForce,
    VectorType& rRightHandSideVector,
...
void BaseDamageSolidElement::CalculateLumpedMassVector(VectorType& rMassVector) const
{
    KRATOS_TRY;
...
void BaseDamageSolidElement::CalculateDampingMatrixWithLumpedMass(
    MatrixType& rDampingMatrix,
    const ProcessInfo& rCurrentProcessInfo
    )
{
...
void BaseDamageSolidElement::save( Serializer& rSerializer ) const
{
...
void BaseDamageSolidElement::load( Serializer& rSerializer )
{
