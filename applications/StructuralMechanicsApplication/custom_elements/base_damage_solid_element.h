...
#define  KRATOS_BASE_DAMAGE_SOLID_ELEMENT_H_INCLUDED
...
/**
 * @class BaseDamageSolidElement
 * @ingroup StructuralMechanicsApplication
 * @brief This is base class used to define the damage solid elements
 * @details The elements derived from this class are the small displacement element with damage modelled with phase field
 * @author Reza Najian Asl
 * @author Shahed Rezaei
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) BaseDamageSolidElement
    : public Element
{
protected:
    /**
...
public:
    ...
    // Counted pointer of BaseDamageSolidElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION( BaseDamageSolidElement );
    ...
    // Constructor void
    BaseDamageSolidElement()
    {};

    // Constructor using an array of nodes
    BaseDamageSolidElement( IndexType NewId, GeometryType::Pointer pGeometry ):Element(NewId,pGeometry)
    {};

    // Constructor using an array of nodes with properties
    BaseDamageSolidElement( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties ):Element(NewId,pGeometry,pProperties)
    {};

    // Copy constructor
    BaseDamageSolidElement(BaseDamageSolidElement const& rOther)
        :BaseType(rOther)
        ,mThisIntegrationMethod(rOther.mThisIntegrationMethod)
    {};

    // Destructor
    ~BaseDamageSolidElement() override
    {};
...
#endif // KRATOS_BASE_DAMAGE_SOLID_ELEMENT_H_INCLUDED  defined
