...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DAMAGE_REACTION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CRACK_STRAIN_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,ELASTIC_STRAIN_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CRACK_STRESS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,ELASTIC_STRESS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,DAMAGE_CONSTITUTIVE_MATRIX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,UNDAMAGE_CONSTITUTIVE_MATRIX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,P_MATRIX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,Ch_MATRIX);
}
