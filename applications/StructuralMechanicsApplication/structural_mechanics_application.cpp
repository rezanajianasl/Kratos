...
KratosStructuralMechanicsApplication::KratosStructuralMechanicsApplication()
    : KratosApplication("StructuralMechanicsApplication"),
      ...
      mDamageSmallDisplacement2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<NodeType >(Element::GeometryType::PointsArrayType(3)))),
      mDamageSmallDisplacement2D4N(0, Element::GeometryType::Pointer(new Quadrilateral2D4<NodeType >(Element::GeometryType::PointsArrayType(4)))),
      mDamageSmallDisplacement2D6N(0, Element::GeometryType::Pointer(new Triangle2D6<NodeType >(Element::GeometryType::PointsArrayType(6)))),
      mDamageSmallDisplacement2D8N(0, Element::GeometryType::Pointer(new Quadrilateral2D8<NodeType >(Element::GeometryType::PointsArrayType(8)))),
      mDamageSmallDisplacement2D9N(0, Element::GeometryType::Pointer(new Quadrilateral2D9<NodeType >(Element::GeometryType::PointsArrayType(9)))),
      mDamageSmallDisplacement3D4N(0, Element::GeometryType::Pointer(new Tetrahedra3D4<NodeType >(Element::GeometryType::PointsArrayType(4)))),
      mDamageSmallDisplacement3D6N(0, Element::GeometryType::Pointer(new Prism3D6<NodeType >(Element::GeometryType::PointsArrayType(6)))),
      mDamageSmallDisplacement3D8N(0, Element::GeometryType::Pointer(new Hexahedra3D8<NodeType >(Element::GeometryType::PointsArrayType(8)))),
      mDamageSmallDisplacement3D10N(0, Element::GeometryType::Pointer(new Tetrahedra3D10<NodeType >(Element::GeometryType::PointsArrayType(10)))),
      mDamageSmallDisplacement3D15N(0, Element::GeometryType::Pointer(new Prism3D15<NodeType >(Element::GeometryType::PointsArrayType(15)))),
      mDamageSmallDisplacement3D20N(0, Element::GeometryType::Pointer(new Hexahedra3D20<NodeType >(Element::GeometryType::PointsArrayType(20)))),
      mDamageSmallDisplacement3D27N(0, Element::GeometryType::Pointer(new Hexahedra3D27<NodeType >(Element::GeometryType::PointsArrayType(27)))),
...
void KratosStructuralMechanicsApplication::Register() {
    ...
    // Damage phase-field variables
    KRATOS_REGISTER_VARIABLE(DAMAGE_REACTION);
    KRATOS_REGISTER_VARIABLE(CRACK_STRAIN_ENERGY); 
    KRATOS_REGISTER_VARIABLE(ELASTIC_STRAIN_ENERGY);  
    KRATOS_REGISTER_VARIABLE(CRACK_STRESS); 
    KRATOS_REGISTER_VARIABLE(ELASTIC_STRESS);
    KRATOS_REGISTER_VARIABLE(DAMAGE_CONSTITUTIVE_MATRIX);
    KRATOS_REGISTER_VARIABLE(UNDAMAGE_CONSTITUTIVE_MATRIX);  
    KRATOS_REGISTER_VARIABLE(P_MATRIX);      
    KRATOS_REGISTER_VARIABLE(Ch_MATRIX);
    ...
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement2D3N", mDamageSmallDisplacement2D3N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement2D4N", mDamageSmallDisplacement2D4N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement2D6N", mDamageSmallDisplacement2D6N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement2D8N", mDamageSmallDisplacement2D8N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement2D9N", mDamageSmallDisplacement2D9N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D4N", mDamageSmallDisplacement3D4N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D6N", mDamageSmallDisplacement3D6N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D8N", mDamageSmallDisplacement3D8N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D10N", mDamageSmallDisplacement3D10N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D15N", mDamageSmallDisplacement3D15N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D20N", mDamageSmallDisplacement3D20N)
    KRATOS_REGISTER_ELEMENT("DamageSmallDisplacementElement3D27N", mDamageSmallDisplacement3D27N)    
    ...
    KRATOS_REGISTER_CONSTITUTIVE_LAW("LinearElasticDamage3DLaw", mElasticIsotropicDamage3D);    
    KRATOS_REGISTER_CONSTITUTIVE_LAW("LinearElasticPlaneStrain2DLaw", mLinearPlaneStrain);
    KRATOS_REGISTER_CONSTITUTIVE_LAW("LinearElasticPlaneStrainDamage2DLaw", mLinearPlaneStrainDamage);    
