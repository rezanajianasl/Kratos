...
#if !defined (KRATOS_ELASTIC_ISOTROPIC_DAMAGE_3D_LAW_H_INCLUDED)
#define  KRATOS_ELASTIC_ISOTROPIC_DAMAGE_3D_LAW_H_INCLUDED
 ...
 */
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) ElasticIsotropicDamage3D
...
public:
    ...
    /// Counted pointer of ElasticIsotropicDamage3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticIsotropicDamage3D );
     ...
     * Copy constructor.
     */
    ElasticIsotropicDamage3D (const ElasticIsotropicDamage3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticIsotropicDamage3D() override;
...
}; // Class ElasticIsotropicDamage3D
}  // namespace Kratos.
#endif // KRATOS_ELASTIC_ISOTROPIC_DAMAGE_3D_LAW_H_INCLUDED  defined
