...
LinearPlaneStrainDamage::LinearPlaneStrainDamage()
    : ElasticIsotropicDamage3D()
{
}
...
LinearPlaneStrainDamage::LinearPlaneStrainDamage(const LinearPlaneStrainDamage& rOther)
    : ElasticIsotropicDamage3D(rOther)
{
}
...
ConstitutiveLaw::Pointer LinearPlaneStrainDamage::Clone() const
{
    return Kratos::make_shared<LinearPlaneStrainDamage>(*this);
}
...
void LinearPlaneStrainDamage::GetLawFeatures(Features& rFeatures)
{
    //Set the type of law
...
void LinearPlaneStrainDamage::CalculateElasticMatrix(Matrix& C, ConstitutiveLaw::Parameters& rValues)
{
...
void LinearPlaneStrainDamage::CalculateCauchyGreenStrain(Parameters& rValues, Vector& rStrainVector)
{
